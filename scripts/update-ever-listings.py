...
{rows_html}
    ...
    <!-- ─── CTA ───────────────────────────────────────────────────────────── -->
    <section class="py-14 bg-tlh-dark text-white text-center">
      <div class="max-w-2xl mx-auto px-4">
        <h2 class="hero-text text-3xl font-bold mb-3" style="font-family:'Source Serif Pro',Georgia,serif;">Have a seller who fits our buy box?</h2>
        <p class="text-white/70 mb-6">All-cash, no contingencies, 24–48hr decision. Estate contents handled.</p>
        <a href="/#contact" class="bg-tlh-teal text-white px-8 py-3 rounded-[5px] font-semibold hover:bg-tlh-teal-dark transition inline-block">Send Us a Property</a>
      </div>
    </section>
